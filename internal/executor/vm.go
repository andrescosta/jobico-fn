...
func (e *VM) Start(ctx context.Context) error {
...
func (e *VM) init(ctx context.Context) error {
...
func (e *VM) addExecutors(ctx context.Context, pkg *pb.JobPackage) error {
...
func (e *VM) removeExecutor(_ context.Context, p *pb.JobPackage) {
