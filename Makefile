...
.PHONY: perf k6 go-build test test_coverage test_html checks hadolint init gosec obs up down stop compose lint vuln build release format local $(FORMAT_FILES)
...
perf:
	perf/k6.exe run perf/script.js
